...
import com.abcs.huaqiaobang.yiyuanyungou.yyg.adapter.YYGMyLotteryRecordAdapter;
 ...
 */
public class YYGMyLotteryRecordFragment extends BaseFragment implements RecyclerViewAndSwipeRefreshLayout.SwipeRefreshLayoutRefresh{
...
//                recyclerViewAndSwipeRefreshLayout.getSwipeRefreshLayout().setRefreshing(true);
    ...
    private void initAllDates() {
        ...
        HttpRequest.sendGet(TLUrl.URL_yyg_goods_my_lottery_record, "userId=" + MyApplication.getInstance().self.getId() + "&page=" + currentPage + "&pageSize=10",
                new HttpRevMsg() {
                    @Override
