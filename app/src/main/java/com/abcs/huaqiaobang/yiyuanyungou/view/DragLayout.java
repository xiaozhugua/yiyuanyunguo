...
public class DragLayout extends ViewGroup {
    ...
    private void animTopOrBottom(View releasedChild, float yvel) {
        ...
        if (releasedChild == frameView1) {
            ...
            if (yvel < -VEL_THRESHOLD
                ...
                //发送广播
                MyUpdateUI.sendUpdateCollection(getContext(), MyUpdateUI.TUWENDETAIL);
            }
        } else {
            // 拖动第二个view松手�
            if (yvel > VEL_THRESHOLD
                ...
                finalTop = viewHeight;
                //发送广播
                MyUpdateUI.sendUpdateCollection(getContext(), MyUpdateUI.GOODSDETAIL);
            }
    ...
    public void turn2Next(int top,float yvel){
        onViewPosChanged(1, top);
        animTopOrBottom(frameView1, yvel);
    }
}
