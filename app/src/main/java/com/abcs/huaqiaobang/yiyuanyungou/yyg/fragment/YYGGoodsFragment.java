...
//        return mFragmentView;
    ...
    private void initRecycler() {
        ...
        if (recyclerView != null) {
            ...
            goodsFragmentAdapter = new YYGGoodsFragmentAdapter(activity);
            initAllDates();
//        fullyGridLayoutManager = new FullyGridLayoutManager(getContext(), 2);
            GridLayoutManager gridLayoutManager = new GridLayoutManager(activity, 2);
            mHeaderAndFooterRecyclerViewAdapter = new HeaderAndFooterRecyclerViewAdapter(goodsFragmentAdapter);
    ...
    private void initAllDates() {
        ...
        if(MyApplication.getInstance().self==null){
            param="status=0" + "&page=" + currentPage + "&pageSize=10";
        }else {
            param="status=0" + "&page=" + currentPage + "&pageSize=10"+"&userId="+ MyApplication.getInstance().self.getId();
        }
                                    ...
                                    if (result.optInt("status") == 1) {
                                        ...
                                        if (jsonArray != null) {
                                            if (isLoadMore) {
                                                ...
                                                int currentSize = goodsFragmentAdapter.getItemCount();
                                                ...
                                                goodsFragmentAdapter.getList().clear();
                                                goodsList.clear();
                                                for (int i = 0; i < jsonArray.length(); i++) {
                                                    Goods goods = new Goods();
                                                    goods.setId(i);
                                                    ...
                                                    goodsFragmentAdapter.addItems(goodsList);
                                                    goodsFragmentAdapter.notifyDataSetChanged();
                                                }
                                            }
                                        } else {
                                        ...
                                        mHasLoadedOnce = true;
                                        Log.i("zjz", "yyg_goods_isMore=" + isMore);
//                                        goodsFragmentAdapter.notifyDataSetChanged();
                                    }
    ...
    private void addItems(ArrayList<Goods> list) {
        ...
        goodsFragmentAdapter.addItems(list);
